  ...
  return (
    <section className={classes.presentation}>
      <div className={classes.introduction}>
        ...
        Sit at the comfort of your home and enjoy delicious food from the best restaurants in the area. 
        We aim at providing safe deliveries while the pandemic outside lasts!
        </Typography>
